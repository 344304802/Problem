...
| `outputs/relation_3d.png` | 问题1：$$C_{out}$$ 与两变量 3D 曲面（U1-U2/T1-T2/C_in-Q/U1-T1） |
...
| `outputs/pareto_front.png` | 多目标 Pareto 前沿：电耗 vs 振打峰值权衡曲线 |
...
| `outputs/r_sensitivity.png` | 振打双向偏离比例 $$r$$ 的敏感性检验（最优电耗几乎不变） |
| `outputs/rapping_sync.png` | 振打同步性：周期比值分布 + 同步 vs 错峰峰值对比 |
